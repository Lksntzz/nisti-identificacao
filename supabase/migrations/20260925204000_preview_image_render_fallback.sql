-- Add a render-time GS fallback URL to each management item without replacing the primary image URL.
  ...
  select
    ...
    jsonb_agg(
      jsonb_build_object(
        ...
        'image_source_sku',ar.image_source_sku,'fallback_image_url',ar.fallback_image_url
      )
