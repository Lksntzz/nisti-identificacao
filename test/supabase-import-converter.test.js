...
INSERT INTO "scan_occurrences" VALUES(101,'occurrences/x.jpg','SHOPEE','CAPA',0.9,'ambiguous_top1_margin',NULL,NULL,'pending',NULL,NULL,'2026-09-14 10:00:00');
INSERT INTO "scan_occurrence_candidates" VALUES(101,'CAPA',1,0.9,77,'product','2026-09-14 10:00:01');
INSERT INTO "scan_occurrence_review_sessions" VALUES(101,'abc123','2026-09-14 10:00:02');
...
`;
  ...
  assert.equal(converted.statementCounts.scan_occurrences, 1);
  assert.equal(converted.statementCounts.scan_occurrence_candidates, 1);
  assert.equal(converted.statementCounts.scan_occurrence_review_sessions, 1);
